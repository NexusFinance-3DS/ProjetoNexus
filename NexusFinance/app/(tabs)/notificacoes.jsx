...
export default function Notificacoes() {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      apiAutenticada("/notificacoes")
        .then(
          (response) =>
            active && setNotificacoes(response.notificacoes)
        )
  ...
  function obterVisual(item) {
    const titulo = item.titulo?.toLowerCase() || "";

    if (titulo.includes("receita")) {
      return VISUAL.Receita;
    }

    if (titulo.includes("despesa")) {
      return VISUAL.Despesa;
    }

    return VISUAL[item.tipo] || VISUAL.Sistema;
  }
